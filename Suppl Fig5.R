...
#P11
total.P11 <- AddModuleScore(total.P11, features = list(stemness.marker), name = "stemness_marker")
...
dev.off()
#P5
total.P5 <- AddModuleScore(total.P5, features = list(stemness.marker), name = "stemness_marker")
png('../../../../../../Manuscript/figures/images/Fig4/Stemness_P5_vlnplot.png',width=3500,height=2500,res=600)
VlnPlot(total.P5, features= "stemness_marker1", group.by="seurat_clusters", pt.size = 0, cols = c("0" = "#E69F00", "1" = "#009E73", "2" = "#666666", "3" = "#F0E442", "4" = "#D55E00", "5" ="#CC79A7", "6" ="#0072B2")) + NoLegend() + ggtitle("Stemness Score") + theme(plot.title = element_text(hjust = 0.5, face="bold")) +xlab("Cluster") + theme(text =element_text(size = 15)) & geom_hline(yintercept = 0.25, col = 'red', linetype = "dashed") 
dev.off()
...
dev.off()
#P27
total.P27 <- AddModuleScore(total.P27, features = list(stemness.marker), name = "stemness_marker")
png('../../../../../../Manuscript/figures/images/Fig4/Stemness_P27_vlnplot.png',width=3500,height=2500,res=600)
VlnPlot(total.P27, features= "stemness_marker1", group.by="seurat_clusters", pt.size = 0, cols = c("0" = "#56B4E9", "1" = "#009E73", "2" = "#E69F00" , "3" = "#F0E442", "4" = "#D55E00", "5" ="#CC79A7","6" = "#666666" )) + NoLegend() + ggtitle("Stemness Score") + theme(plot.title = element_text(hjust = 0.5, face="bold")) +xlab("Cluster") + theme(text =element_text(size = 15)) & geom_hline(yintercept = 0.25, col = 'red', linetype = "dashed") 
dev.off()
png('../../../../../../Manuscript/figures/images/Fig4/UMAP_P27.png',width=3500,height=2500,res=600)
DimPlot(total.P27, reduction = "umap", cols = c("0" = "#56B4E9", "1" = "#009E73", "2" = "#E69F00" , "3" = "#F0E442", "4" = "#D55E00", "5" ="#CC79A7", "6" = "#666666")) + ggtitle ("Cluster") + theme(plot.title = element_text(hjust = 0.5, face="bold")) + theme(text =element_text(size = 15)) 
dev.off()
png('../../../../../../Manuscript/figures/images/Fig4/barplot_P27.png',width=3500,height=2500,res=600)
dittoBarPlot(total.P27, "seurat_clusters", group.by = "Patient", color.panel = c("#56B4E9", "#009E73","#E69F00","#F0E442", "#D55E00","#CC79A7", "#666666")) + ylab("Cluster Frequency")+ xlab("Disease Stage") + ggtitle("") + theme(plot.title = element_text(hjust = 0.5, face="bold")) +  theme(text =element_text(size = 15)) + NoLegend()                                                                                                                                                                                                                                  
dev.off()
#P9
total.P9 <- AddModuleScore(total.P9, features = list(stemness.marker), name = "stemness_marker")
...
dev.off()
#P4
total.P4 <- AddModuleScore(total.P4, features = list(stemness.marker), name = "stemness_marker")
png('../../../../../../Manuscript/figures/images/Fig4/Stemness_P4_vlnplot.png',width=3500,height=2500,res=600)
VlnPlot(total.P4, features= "stemness_marker1", group.by="seurat_clusters", pt.size = 0, cols = c("0" = "#E69F00", "1" = "#009E73", "2" = "#56B4E9", "3" = "#F0E442")) + NoLegend() + ggtitle("Stemness Score") + theme(plot.title = element_text(hjust = 0.5, face="bold")) +xlab("Cluster") + theme(text =element_text(size = 15)) & geom_hline(yintercept = 0.25, col = 'red', linetype = "dashed") 
dev.off()
png('../../../../../../Manuscript/figures/images/Fig4/UMAP_P4.png',width=3500,height=2500,res=600)
DimPlot(total.P4, reduction = "umap", cols = c("0" = "#E69F00", "1" = "#009E73", "2" = "#56B4E9", "3" = "#F0E442")) + ggtitle ("Cluster") + theme(plot.title = element_text(hjust = 0.5, face="bold")) + theme(text =element_text(size = 15)) 
dev.off()
png('../../../../../../Manuscript/figures/images/Fig4/barplot_P4.png',width=3500,height=2500,res=600)
dittoBarPlot(total.P4, "seurat_clusters", group.by = "Patient", color.panel = c("#E69F00", "#009E73","#56B4E9","#F0E442" )) + ylab("Cluster Frequency")+ xlab("Disease Stage") + ggtitle("") + theme(plot.title = element_text(hjust = 0.5, face="bold")) +  theme(text =element_text(size = 15)) + NoLegend()                                                                                                                                                                                                                                  
dev.off()
