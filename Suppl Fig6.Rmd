...
comparing_groups <- list(c("Initial", "Relapse") ) 
p <- ggpaired(my_data, x = "Disease_Stage", y = "logAUC", add = "dotplot", color = "Disease_Stage", palette =c("#56B4E9", "#56B4E9"), ylab = "logAUC", xlab = "Disease Stage")  
png('/g/korbel/Costea/Manuscript/figures/images/Fig6/DRP_A1331852_barplot.png',width=4000,height=2500,res=600)
p + stat_compare_means(comparisons = comparing_groups, label.y = 8, method = "t.test", paired = TRUE, label = "p.signif") + theme(plot.title = element_text(hjust = 0.5, face="bold")) + theme(text =element_text(size = 15)) + NoLegend() + ggtitle("A1331852")
dev.off()
```
